...
\midrule
\textbf{Pipeline~A hits}   & 45{,}880~~(45.9\%) & 30{,}376~~(30.4\%) \\
\textbf{Pipeline~A misses} &  2{,}600~~~(2.6\%) & 21{,}144~~(21.1\%) \\
\bottomrule
\end{tabular}
\vspace{4pt}
...
Pipeline~B rescues \textbf{11.0\%} of Pipeline~A misses.
Union HR@10 = \textbf{0.7886} vs.\ Pipeline~A alone = 0.7626
(+3.4\% relative).
\end{table}
